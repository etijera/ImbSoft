    ...
    public class DataBase
    {
        ...
        public static bool ExecuteNonQuery(string pTextoComando, CommandType Type, SqlParameter[] QueryParameters, SqlConnection Conn)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    XtraMessageBox.Show("El Campo que intenta añadir ya existe en la tabla", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
                    if (ex == "Violation of UNIQUE KEY constraint 'IX_GlTables'. Cannot insert duplicate key in object 'dbo.GlTables'.\r\nThe statement has been terminated.")
                    {
                        XtraMessageBox.Show("La Tabla que intenta añadir ya existe", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        XtraMessageBox.Show(e.Message, Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
