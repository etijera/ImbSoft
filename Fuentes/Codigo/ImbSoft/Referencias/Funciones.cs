...
namespace Referencias
{
    public class Funciones
    {
        ...
        {
            // Summary:
            //  No tiene ningun formato numerico
            Ninguno = 0,

            // Summary:
            //  d:  Numeros Enteros Ej: 1 o 1
            Decimal = 1,

            // Summary:
            //  n1:  Numeros decimales con una cifra despues del punto Ej: 1.0 o -1.0
            Numerico1 = 2,

            // Summary:
            //  n2:  Numeros decimales con dos cifras despues del punto Ej: 1.00 o -1.00
            Numerico2 = 3,

            // Summary:
            //  n3:   Numeros decimales con tres cifras despues del punto Ej: 1.000 o -1.000
            Numerico3 = 4,

            // Summary:
            //  P:1   Numeros porcentaje con una cifra despues del punto Ej: 1.0 o -1.0
            Porcentaje1 = 5,

            // Summary:
            //  P:2   Numeros porcentaje con dos cifras despues del punto Ej: 1.00 o -1.00
            Porcentaje2 = 6,

            // Summary:
            //  P:3   Numeros porcentaje con tres cifras despues del punto Ej: 1.000 o -1.000
            Porcentaje3 = 7,
        ...
        public bool Auxiliar(string codigoPuc)
        {
            ...
            if (!String.IsNullOrEmpty(codigoPuc))
            {
                ...
                {
                    r = false;
                    XtraMessageBox.Show("El código debe ser un auxiliar", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            return r;
        }
        ...
        public void StartProcess(string path)
        {
            ...
            {
                MessageBox.Show(e.Message, Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public String GetConcecutivo(String Database, String TipoDoc, String mensaje, string Tipo)
        {
            ...
            else
            {
                ...
                MessageBox.Show(mensaje, Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            return conse;
        }
        ...
        //    {
        //        MessageBox.Show("Datos no encontrados, verifique los datos por favor...!", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
        //    }
        ...
        //            else
        //            {
        //                XtraMessageBox.Show("Debe seleccionar el tipo de pagina de la factura.", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        //            }
        //        }
        //        else
        //        {
        //            XtraMessageBox.Show("No se puede imprimir la factura.", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        //        }

        //    }
        //    catch (Exception ex)
        //    {
        //        XtraMessageBox.Show(" " + ex, Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
        //    }
        //}
        ...
        public bool ValidarFecha(DateTime fecha, int MesPeriodo, int AñoPeriodo, String dataBase)
        {
            ...
            if (cierre)
            {
                XtraMessageBox.Show("Error, el período está cerrado. Por favor verifique.", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                retorno = false;
            }
            ...
            if (MesPeriodo != fecha.Month || AñoPeriodo != fecha.Year)
            {
                ...
                XtraMessageBox.Show("El documento que intenta crear no corresponde al periodo que se esta trabajando (" + mes + " " + AñoPeriodo + "). Por favor verifique.", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                retorno = false;
            }
