...
namespace Referencias
{
    public class Email
    {
        ...
        public void EnviarCorreo(Object[] correos, string asunto, string body, Object[] files)
        {
            ...
            {
                XtraMessageBox.Show("Configure la cuenta de correo electronico", Referencias.Properties.Resources.AppName); return;
            }            
            ...
            {
                XtraMessageBox.Show("Mensaje no enviado", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        #endregion
    }
