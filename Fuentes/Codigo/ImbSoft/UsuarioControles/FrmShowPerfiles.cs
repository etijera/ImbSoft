...
{
    public partial class FrmShowPerfiles : FormularioBase
    {
        ...
        private void BtnReubicar_Click(object sender, EventArgs e)
        {
            ...
            if (XtraMessageBox.Show("¿Está seguro que desea cambiar la ubicación de los archivos de configuración del perfil?", Referencias.Properties.Resources.AppName, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
