...
{
    public partial class FrmShowIt : FormularioBase
    {
        #region Propiedades
        /// <summary>
        ...
        public void Añadir()
        {
            if (permisoAdicionar)
            {
                ...
                try
                {
                    ...
                    if (PerfilShow.Formulario.Equals("UsuarioControles.FrmGetCodeName"))
                    {
                ...
                {
                    XtraMessageBox.Show(ex.Message, Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            ...
            {
                XtraMessageBox.Show("El usuario " + Usuario + " no tiene permiso para realizar esta operación.", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public void Editar()
        {
            if (permisoEditar)
            {
                ...
                if (GvGeneral.GetFocusedDataSourceRowIndex() > -1)
                {
                    ...
                    XtraMessageBox.Show("Debe seleccionar un registro", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2);
            }
            else
            {
                XtraMessageBox.Show("El usuario " + Usuario + " no tiene permiso para realizar esta operación.", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public void Imprimir()
        {
            if (permisoImprimir)
            {
                if (PerfilShow.Formulario.Equals("UsuarioControles.FrmGetCodeName") || PerfilShow.Formulario.Equals("UsuarioControles.FrmGetName"))
                {
                    try
                    {
                        string camp = "";
