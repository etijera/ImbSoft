...
namespace UsuarioControles
{
    public partial class RangoFecha : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void TxtFechaFin_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("La fecha final no puede ser menor que la inical", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
                TxtFechaFin.Focus();
                return;
            }
        ...
        private void TxtFechaFin_Validated(object sender, EventArgs e)
        {
            if (ValidarAño == true)
            {
                ...
                {
                    XtraMessageBox.Show("Las fechas deben ser del mismo año", Referencias.Properties.Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    TxtFechaFin.Focus();
                    return;
                }
            }
